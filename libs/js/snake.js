...
//     var score = document.querySelector('#scoreViv')
    
//     score.textContent = state.snake.length;
...
//     var direction = DIRECTIONS_MAP[e.key];
//     console.log(DIRECTIONS_MAP[e.key])
...
//     score.textContent = state.snake.length**4;
//         return
//     }

//     var facBtn = document.querySelector("#facBtn")
...
//         GROW_SCALE = 3
//     })
//     var difBtn = document.querySelector("#difBtn")
...
function drawPixel(color, x, y) {
    ...
    var score = document.querySelector('#scoreViv')
        ...
        score.textContent = state.snake.length**3;  
